...
import foro.hub.api.domain.usuario.DatosAutentificacion;
...
public class AutentificacionController {
    ...
    public ResponseEntity iniciarSesion(@RequestBody @Valid DatosAutentificacion datos){
        ...
        var autentificaion=manager.authenticate(authenticationToken);
        var tokenJWT=tokenService.generarToken((Usuario) autentificaion.getPrincipal());
